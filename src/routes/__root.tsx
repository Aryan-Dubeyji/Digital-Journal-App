...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Marginalia — A quiet digital journal" },
      {
        name: "description",
        content:
          "Marginalia is a calm, distraction-free digital journal. Write daily, track your mood, and keep your reflections in one place. Local-first, private by design.",
      },
      { name: "author", content: "Marginalia" },
      { property: "og:title", content: "Marginalia — A quiet digital journal" },
      {
        property: "og:description",
        content: "A calm, local-first journaling app for daily reflection.",
      },
